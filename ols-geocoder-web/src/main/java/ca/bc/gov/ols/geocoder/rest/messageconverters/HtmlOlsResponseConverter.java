...
@Component
public class HtmlOlsResponseConverter extends AbstractHttpMessageConverter<OlsResponse> 
{
	
	@Autowired
	private IGeocoder geocoder;
	
	public HtmlOlsResponseConverter() {
	...
	protected void writeInternal(OlsResponse response, HttpOutputMessage outputMessage)
		...
		HtmlOlsResponseWriter responseWriter = new HtmlOlsResponseWriter(out, config);
