...
<a name="FAULTS.tooMany">FAULTS.tooMany</a> |Indicates that too many faults were found in the provided input address which may prevent a successful address match.|6
...
<a name="LOCALITY.partialMatch">LOCALITY.partialMatch</a> | The locality name was missing a locality qualifier, but was still valid without it. A match with a full locality name is returned.|0
