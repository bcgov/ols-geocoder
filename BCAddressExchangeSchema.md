...
RELATIVE_LOCATION|String|step by step directions to a non-civic address location or relative geographic location of a locality (e.g.,Port Alberni - Head of Alberni Inlet, south central Vancouver Island)|No|Yes	
