...
RELATIVE_LOCATION|String|step by step directions to a non-civic address location or relative geographic location of a locality (e.g.,  W side of Shackleton Glacier in the Clemenceau Icefield, just E of Cummins Lakes Provincial Park)|No|Yes	
