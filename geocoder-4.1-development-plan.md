...
|Consult with clients to better understand their geocoding needs|In progress|Conducted consultations with MoH, MCFD, Vital Stats, and BC EHS;<br><br>Discussed providing address CHSA with MoH, MCFD, and BC EHS; all agreed it would be useful to business for reporting, analysis, and planning; BC EHS was in process of proposing a project to compute address CHSA, asked for estimate and offered to pitch a funding request to their management 
