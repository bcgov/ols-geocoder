...
|Improve geocoder documentation|In progress|Added batch geocoder application guide, geocoder-4.1-development-plan (this document), OSM base-suitability assessment, and product vision. Previously added geocoder scoring guide and reference, batch geocoder registration, batch geocoder UAT process, rejected address examples, conceptual model of addressing,  unit descriptors, and abbreviations. All docs are listed [here](https://github.com/bcgov/ols-geocoder/blob/gh-pages/README.md)
