...
|:--:|--|--|
|Gather|Gather reference road, address, and occupant data from authoritative sources.|Manual download from websites run by Integrated Cadastral Initiative Society, BC Assessment, GeoBC, and municipalities that have addresses on their open data websites but are not members of the ICI Society. For the latest occupants, manually initiate the occupant export function of the Geographic Site Registry in the BC Geographic Warehouse.
