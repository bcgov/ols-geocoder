...
||Addresses are also rejected if their street doesn't exist within the specified locality. For example, an address like 10 Main St W, Lantzville will pass field-level validation. To determine existence of *Main St W* in *Lantzville*, a street-level geocode of the address is needed.
