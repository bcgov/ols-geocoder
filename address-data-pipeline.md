...
|Integrate| Integrate reference addresses into reference road segments (blocks)|A standalone Java application (e.g., WAR file) called Geocodable BC Maker which contains an embedded instance of the online geocoder|
