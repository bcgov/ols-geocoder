...
||Each source dataset may have a different access method (e.g. download, API), data schema, and update schedule| Latest OGL-licensed occupants are automatically exported from the Geographic Site Registry to a staging area then verified manually.
