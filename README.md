...
[Preparing your Address File for Batch Geocoding](https://github.com/bcgov/ols-geocoder/blob/gh-pages/batch_address_data_prep.md)|An example-driven introduction to the input formats supported by the Address List Editor and the batch geocoder|Everyone
...
[Understanding Batch Geocoder Output](https://github.com/bcgov/ols-geocoder/blob/gh-pages/understanding_geocoder_results.md)|An example-driven introduction to the geocoder scoring system and the many fault messages that can help you pinpoint data issues.|Everyone
