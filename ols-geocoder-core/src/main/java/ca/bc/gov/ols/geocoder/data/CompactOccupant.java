...
public class CompactOccupant implements IOccupant {

	private static final Logger logger = LoggerFactory.getLogger(GeocoderConfig.LOGGER_PREFIX
			+ CompactOccupant.class.getCanonicalName());
	...
	public CompactOccupant(int id, UUID uuid, ISite site, String name, String description, 
			String aliasAddress, BusinessCategory businessCategory,
			LocalDate dateUpdated, LocalDate dateAdded) {
		this.id = id;
		this.uuid = uuid;
		this.site = site;
		this.name = name;
